...
import { type DocumentByName, type GenericDataModel, type GenericQueryCtx, type PaginationOptions, type PaginationResult, type SchemaDefinition, type TableNamesInDataModel } from "convex/server";
...
}, "required", "model" | "where" | "sortBy" | "select" | "limit" | "offset" | "sortBy.field" | "sortBy.direction">;
